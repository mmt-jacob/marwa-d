...
class ApplicabilityTracker:
    ...
    def model_applicability(self, param):
        ...
        if d_class == "Setting":
            ...
            # VC Model
            if model in [Models.VC, Models.VC_E]:
            ...
            # VC Pro Model
            elif model in [Models.VC_PRO, Models.VC_PRO_E]:
                # O2 Concentrator Activate
                # Suction Activate
                # Nebulizer Activate
                # O2 Flow Equivalent
            ...
            # VOCSN Model
            elif model in [Models.VOCSN, Models.VOCSN_E]:
                # FiO2 Control
                # FiO2 Monitor
                if p_id in {"41", "72"}:
                    a = False
            ...
            # VCSN Pro Model
            elif model in [Models.VCSN_PRO, Models.VCSN_PRO_E]:
                # O2 Concentrator Activate
                if p_id in {"3"}:
                    a = False

            # V Pro Model
            elif model in [Models.V_PRO, Models.V_PRO_E]:
                # O2 Concentrator Activate
                # Cough Assist
                # Suction Activate
                # Nebulizer Activate
