...
class TermsLanding extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            <div>
                <div className={classes.content}>
                    <div className={classes.message} style={{marginTop: '45px', fontSize: '30px'}}>
                        Multi-View Reports Portal
                    </div>
                    <Button className={classNames(classes.orangeButton, classes.enter)} tabIndex={-1}
                            onClick={() => (this.enter())}>
                        Enter
                    </Button>
                    <div className={classes.message} style={{margin: '20px', fontSize: '16px'}}>
...
export default withStyles(styles, { withTheme: true })(withApollo(TermsLanding));
